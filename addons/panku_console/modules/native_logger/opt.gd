...
@export var screen_overlay:bool = OS.is_debug_build():
	set(v):
		_module.output_overlay.visible = v
	get:
		return _module.output_overlay.visible
@export_range(0.0, 1.0, 0.01) var screen_overlay_alpha:float = 0.75:
	set(v):
		_module.output_overlay.opacity = v
	get:
		return _module.output_overlay.opacity
@export_range(8, 24) var screen_overlay_font_size:int = 13:
	set(v):
