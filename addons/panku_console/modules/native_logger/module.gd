...
func init_module():
	...
	native_logs_monitor.name = "NativeLogMonitor"
	...
	core.move_child(output_overlay, 0)
...
func toggle_overlay(solid_mode: bool = false):
	output_overlay.visible = not output_overlay.visible
	output_overlay.solid_mode = solid_mode
