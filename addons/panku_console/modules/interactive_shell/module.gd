...
const PankConsoleUI = preload("./console_ui/panku_console_ui.gd")
const MiniREPL2 = preload("./mini_repl_2.gd")

var window:PankuLynxWindow
var interactive_shell:PankConsoleUI
var simple_launcher:MiniREPL2
...
func output(any):
	interactive_shell.output(any)

func clear_output():
	interactive_shell.clear_output()
...
func init_module():
	...
	pause_if_popup = load_module_data("pause_if_popup", false)
...
func quit_module():
	...
	save_module_data("pause_if_popup", pause_if_popup)
